<script>/*<![CDATA[*/ 
  document.getElementById('key2sticky').appendChild(
    document.getElementById('notifyFloat')
  ); 
/*]]>*/</script>
    <script>/*<![CDATA[*/ 
  document.getElementById('trailer').appendChild(
